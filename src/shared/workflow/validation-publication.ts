...
async function runLockedPublicationPhase(
    ...
    if (publicationAttempt && publicationAttempt.targetBranch !== targetBranch) {
        const message =
            `The Plan target changed from ${publicationAttempt.targetBranch} to ${targetBranch}. Publication is paused; the saved attempt still targets ${publicationAttempt.targetBranch}.`;
